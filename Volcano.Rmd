...
This is an analysis of the Volcano data set. This data comes form the Smithsonian Institution as early as 1883.
...
```{r}
exploratory_data %>%
  count(last_eruption_year)

ggplot() +
  geom_bar(mapping = aes(x = region)), color = pink", fill = "black") +
  labs(title = "Last Eruption"),x= "region", y= "Count"))
